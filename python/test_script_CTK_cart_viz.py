...
sim_setup(
    ...
    compress=0,
    draw_vox=True,
    draw_backend='mayavi', #will draw 'voxelization' (spheres are active boundary nodes, cubes rigid boundary nodes). For some reason polyscope works and mayavi doesn't
)
